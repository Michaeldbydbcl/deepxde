...
def main():
    ...
    print(len(y_plot_l), "and ", len(y_plot_h))    # What is the length of the dataset
    ...
    print(len(x_train_l), "and ", len(y_train_l), "and ", len(x_train_h), "and ", len(y_train_h))    # What is the length of the dataset
