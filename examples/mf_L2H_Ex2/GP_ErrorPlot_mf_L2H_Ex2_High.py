...
if __name__ == "__main__":
    ...
    for i in range(4, 25, 2):
        ...
        f = open("GP_L2Error_Ex2_High_Change_Low_One_Fix.dat", "a")

        main()
    
    x_Error = Get_Data("GP_L2Error_Ex2_High_Change_Low_One_Fix.dat", 0, 1)
    y_Error = Get_Data("GP_L2Error_Ex2_High_Change_Low_One_Fix.dat", 1, 2)
    ...
    for i in range(4, 25, 2):
        Write_Data("dataset\mf_hi_train.dat", i, func_hi, "w")
        f = open("GP_L2Error_Ex2_High_Change_Low_Two_Fix.dat", "a")

        main()
    
    x_Error = Get_Data("GP_L2Error_Ex2_High_Change_Low_Two_Fix.dat", 0, 1)
    y_Error = Get_Data("GP_L2Error_Ex2_High_Change_Low_Two_Fix.dat", 1, 2)
