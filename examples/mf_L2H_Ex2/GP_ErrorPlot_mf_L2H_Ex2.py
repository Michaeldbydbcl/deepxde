...
if __name__ == "__main__":
    ...
    f = open("GP_L2Error_Ex2.dat", "w").close()     # Firstly, clear the content of the file

    for i in range(4, 50, 5):
        Write_Data("dataset\mf_hi_train.dat", i, func_hi, "w")
        f = open("GP_L2Error_Ex2.dat", "a")

        main()
    
    x_Error = Get_Data("GP_L2Error_Ex2.dat", 0, 1)
    y_Error = Get_Data("GP_L2Error_Ex2.dat", 1, 2)
