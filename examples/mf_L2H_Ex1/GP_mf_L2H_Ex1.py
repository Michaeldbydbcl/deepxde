...
# Read the data from "dateset" folder by importing function from mf_L2H_Plot.property
from mf_L2H_Plot import Get_Data
from Gen_Num_L2H import Write_Data
...
##### From previous example of Gaussian process
    ...
    # x_plot = np.append(x_plot_l, x_plot_h)
