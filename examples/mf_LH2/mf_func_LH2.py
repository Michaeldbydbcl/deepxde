...
# THe title of this file "LH2" means one has 1 "L"ow fidelity datasets and 2 "H"igh fidelity dataset
...
def main():
    ...
    num_test = 1000
    data = dde.data.MfFunc_LH2(geom, func_lo, func_hi_one, func_hi_two, 100, 100, 100, num_test)
